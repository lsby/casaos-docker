#!/usr/bin/bash
#
#           CasaOS Installer Script v0.4.13#
...
readonly CASA_UNINSTALL_URL="https://get.casaos.io/uninstall/v0.4.13"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-AppManagement/releases/download/v0.4.9-alpha9/linux-${TARGET_ARCH}-casaos-app-management-v0.4.9-alpha9.tar.gz"
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS/releases/download/v0.4.13/linux-${TARGET_ARCH}-casaos-v0.4.13.tar.gz"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-UI/releases/download/v0.4.12/linux-all-casaos-v0.4.12.tar.gz"
...
DownloadAndInstallCasaOS() {
    ...
    # 修改: 在打包docker时, 环境比较确定, 不需要在这里验证和重启服务
